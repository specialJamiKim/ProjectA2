...
class CenterDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 홈 버튼 클릭 리스너 설정
        val homeImageView = findViewById<ImageView>(R.id.homeImageViewUserEdit3)
        ...
        // 지도 버튼 클릭 리스너 설정
        val mapFloatingActionButton = findViewById<FloatingActionButton>(R.id.mapFabUserEdit3)
        ...
        // 마이페이지 버튼 클릭 리스너 설정
        val myPageImageView = findViewById<ImageView>(R.id.myPageImageView3)
